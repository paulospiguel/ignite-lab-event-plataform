...
export type GetLessonSlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', videoId: string, description?: string | null, title: string, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
